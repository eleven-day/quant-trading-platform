...
[AKShare](index.html.md)
  * [](index.html.md)
  * AKShare 版本更新
  * [ 查看页面源码](_sources_changelog.md.txt.md)

# [AKShare](https://github.com/akfamily/akshare) 版本更新[](https://akshare.akfamily.xyz/changelog.html#akshare "Link to this heading")
## 接口更名一览表[](https://akshare.akfamily.xyz/changelog.html#id1 "Link to this heading")
...
## 更新说明详情[](https://akshare.akfamily.xyz/changelog.html#id2 "Link to this heading")
...
## 版本更新说明[](https://akshare.akfamily.xyz/changelog.html#id3 "Link to this heading")
1.16.98 fix: fix fund_open_fund_info_em interface
1.16.97 fix: fix fund_open_fund_info_em interface
1.16.96 fix: fix stock_individual_spot_xq interface
1.16.95 fix: fix option_shfe_daily interface
...
1.4.46 fix: fix energy_oil_detail interface
1.4.45 fix: fix air_quality_rank interface
[ 上一页](demo.html _AKShare 策略示例_.md) [下一页 ](contributing.html _AKShare 贡献源码_.md)

...
Table of contents:
  ...
  * [AKShare 策略示例](demo.html.md)
    * [PyBroker 介绍](https://akshare.akfamily.xyz/demo.html#pybroker)
      * [PyBroker 安装](https://akshare.akfamily.xyz/demo.html#id1)
    ...
    * [Backtrader 介绍](https://akshare.akfamily.xyz/demo.html#backtrader)
      * [Backtrader 下载和安装](https://akshare.akfamily.xyz/demo.html#id4)
    * [Backtrader 系列教程](https://akshare.akfamily.xyz/demo.html#id5)
    * [Backtrader 股票策略](https://akshare.akfamily.xyz/demo.html#id6)
      * [基本策略](https://akshare.akfamily.xyz/demo.html#id7)
        * [代码](https://akshare.akfamily.xyz/demo.html#id8)
        * [结果](https://akshare.akfamily.xyz/demo.html#id9)
        * [可视化](https://akshare.akfamily.xyz/demo.html#id10)
      * [参数优化](https://akshare.akfamily.xyz/demo.html#id11)
        * [代码](https://akshare.akfamily.xyz/demo.html#id12)
        * [结果](https://akshare.akfamily.xyz/demo.html#id13)
...
[AKShare](index.html.md)
  * [](index.html.md)
  * AKShare 策略示例
  * [ 查看页面源码](_sources_demo.md.txt.md)

# [AKShare](https://github.com/akfamily/akshare) 策略示例[](https://akshare.akfamily.xyz/demo.html#akshare "Link to this heading")
...
## PyBroker 介绍[](https://akshare.akfamily.xyz/demo.html#pybroker "Link to this heading")
...
### PyBroker 安装[](https://akshare.akfamily.xyz/demo.html#id1 "Link to this heading")
PyBroker 支持在 Windows、macOS 和 Linux 中的 Python 3.9（建议使用 Python 3.11）及以上版本使用。其安装非常简单， 只需要 `pip install lib-pybroker` 就可以实现一键安装。
## PyBroker 系列教程[](https://akshare.akfamily.xyz/demo.html#id2 "Link to this heading")
  1. [AKQuant-开源项目](https://akquant.akfamily.xyz)

## PyBroker 策略示例[](https://akshare.akfamily.xyz/demo.html#id3 "Link to this heading")
```
# 导入所需的库和模块
importpybrokeraspb
frompybrokerimport Strategy, ExecContext
frompybroker.ext.dataimport AKShare
...
defbuy_with_stop_loss(ctx: ExecContext):
  pos = ctx.long_pos()
  if not pos:
...
```
Loadingbardata...
Loadedbardata:0:00:00
Backtesting:2020-01-3100:00:00to2023-02-2800:00:00
Loadingbardata...
Loadedbardata:0:00:00
Testsplit:2020-02-0300:00:00to2023-02-2800:00:00
100%(748of748)|######################| Elapsed Time: 0:00:00 Time: 0:00:00
Finishedbacktest:0:00:03
namevalue
0trade_count373.0000
1initial_market_value500000.0000
2end_market_value467328.0900
3total_pnl-33322.7800
4unrealized_pnl650.8700
5total_return_pct-6.6646
6total_profit530528.5100
7total_loss-563851.2900
8total_fees0.0000
9max_drawdown-113004.2700
10max_drawdown_pct-20.2704
11win_rate45.9215
12loss_rate54.0785
13winning_trades152.0000
14losing_trades179.0000
15avg_pnl-89.3372
16avg_return_pct-0.0160
17avg_trade_bars1.0000
18avg_profit3490.3191
19avg_profit_pct0.6958
20avg_winning_trade_bars1.0000
21avg_loss-3150.0072
22avg_loss_pct-0.6241
23avg_losing_trade_bars1.0000
24largest_win31157.9400
25largest_win_pct5.9200
26largest_win_bars1.0000
27largest_loss-12682.6000
28largest_loss_pct-2.3100
29largest_loss_bars1.0000
30max_wins8.0000
31max_losses7.0000
32sharpe-0.0132
33sortino-0.0231
34profit_factor0.9638
35ulcer_index1.7639
36upi-0.0039
37equity_r20.5876
38std_error27448.1177

```

## Backtrader 介绍[](https://akshare.akfamily.xyz/demo.html#backtrader "Link to this heading")
...
### Backtrader 下载和安装[](https://akshare.akfamily.xyz/demo.html#id4 "Link to this heading")
[Backtrader](https://www.backtrader.com) 的下载和安装都比较简单，尤其是在配置好 [AKShare](https://github.com/akfamily/akshare) 的 基础上，我们只需要 `pip install backtrader` 就可以实现一键安装。如果需要了解 [AKShare](https://github.com/akfamily/akshare) 的 环境配置，请参考 [AKShare 环境配置](anaconda.html.md) 来设置本地环境。想要通过源码来安装的小伙伴，可以访问 [Backtrader 的 GitHub 地址](https://github.com/mementum/backtrader) 来下 载安装，由于源码安装比较繁琐，建议直接通过 `pip` 或 `conda` 来安装和使用。需要注意的是如果要输出图形，请安装 `pip install matplotlib==3.2.2`
## Backtrader 系列教程[](https://akshare.akfamily.xyz/demo.html#id5 "Link to this heading")
...
## Backtrader 股票策略[](https://akshare.akfamily.xyz/demo.html#id6 "Link to this heading")
### 基本策略[](https://akshare.akfamily.xyz/demo.html#id7 "Link to this heading")
#### 代码[](https://akshare.akfamily.xyz/demo.html#id8 "Link to this heading")
```
fromdatetimeimport datetime
importbacktraderasbt # 升级到最新版
importmatplotlib.pyplotasplt # 由于 Backtrader 的问题，此处要求 pip install matplotlib==3.2.2
importakshareasak # 升级到最新版
importpandasaspd
...
#### 结果[](https://akshare.akfamily.xyz/demo.html#id9 "Link to this heading")
```
初始资金: 1000000
...
#### 可视化[](https://akshare.akfamily.xyz/demo.html#id10 "Link to this heading")
...
### 参数优化[](https://akshare.akfamily.xyz/demo.html#id11 "Link to this heading")
#### 代码[](https://akshare.akfamily.xyz/demo.html#id12 "Link to this heading")
```
fromdatetimeimport datetime
importakshareasak
...
"""
  ...
  deflog(self, txt, dt=None, do_print=False):
"""
...
defmain(code="600070", start_cash=1000000, stake=100, commission_fee=0.001):
...
#### 结果[](https://akshare.akfamily.xyz/demo.html#id13 "Link to this heading")
```
期初总资金: 1000000.00
...
[ 上一页](platform.html _AKShare 量化专题_.md) [下一页 ](changelog.html _AKShare 版本更新_.md)

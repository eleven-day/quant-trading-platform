...
Table of contents:
  ...
  * [AKShare 安装指导](installation.html.md)
    ...
    * [安装 AKShare](https://akshare.akfamily.xyz/installation.html#id2)
      * [通用安装](https://akshare.akfamily.xyz/installation.html#id3)
      * [国内安装-Python](https://akshare.akfamily.xyz/installation.html#python)
      * [国内安装-Anaconda](https://akshare.akfamily.xyz/installation.html#anaconda)
    ...
    * [R 语言调用支持](https://akshare.akfamily.xyz/installation.html#r)
      * [安装 Anaconda](https://akshare.akfamily.xyz/installation.html#id6)
      * [安装 R 语言](https://akshare.akfamily.xyz/installation.html#id7)
      * [升级 R 语言到最新版本](https://akshare.akfamily.xyz/installation.html#id8)
        * [Windows](https://akshare.akfamily.xyz/installation.html#windows)
        * [Mac](https://akshare.akfamily.xyz/installation.html#mac)
      * [在 R 语言中安装相应的包](https://akshare.akfamily.xyz/installation.html#id9)
    * [MATLAB 调用支持](https://akshare.akfamily.xyz/installation.html#matlab)
      * [安装 Anaconda](https://akshare.akfamily.xyz/installation.html#id10)
      * [安装 MATLAB](https://akshare.akfamily.xyz/installation.html#id11)
      * [配置环境](https://akshare.akfamily.xyz/installation.html#id12)
        * [测试环境配置](https://akshare.akfamily.xyz/installation.html#id13)
        * [测试调用 AKShare 接口](https://akshare.akfamily.xyz/installation.html#id14)
      * [调用 AKShare](https://akshare.akfamily.xyz/installation.html#id15)
        * [不带参数接口调用](https://akshare.akfamily.xyz/installation.html#id16)
        * [带参数接口调用](https://akshare.akfamily.xyz/installation.html#id17)
      * [转换数据格式](https://akshare.akfamily.xyz/installation.html#id18)
        * [演示](https://akshare.akfamily.xyz/installation.html#id19)
    * [安装报错解决方案](https://akshare.akfamily.xyz/installation.html#id20)
      * [1. 安装超时的错误](https://akshare.akfamily.xyz/installation.html#id21)
      * [2. 拒绝访问错误](https://akshare.akfamily.xyz/installation.html#id22)
      * [3. 提示其他的错误](https://akshare.akfamily.xyz/installation.html#id23)
...
[AKShare](index.html.md)
  * [](index.html.md)
  * AKShare 安装指导
  * [ 查看页面源码](_sources_installation.md.txt.md)

# [AKShare](https://github.com/akfamily/akshare) 安装指导[](https://akshare.akfamily.xyz/installation.html#akshare "Link to this heading")
## 重要提示[](https://akshare.akfamily.xyz/installation.html#id1 "Link to this heading")
  ...
  4. 对于熟悉容器技术的小伙伴, 可以安装 Docker 使用, 指导教程如下: [AKShare Docker 部署](akdocker_akdocker.html.md).

## 安装 [AKShare](https://github.com/akfamily/akshare)[](https://akshare.akfamily.xyz/installation.html#id2 "Link to this heading")
### 通用安装[](https://akshare.akfamily.xyz/installation.html#id3 "Link to this heading")
```
...
### 国内安装-Python[](https://akshare.akfamily.xyz/installation.html#python "Link to this heading")
```
pip install akshare --upgrade -i https://pypi.tuna.tsinghua.edu.cn/simple

```

### 国内安装-Anaconda[](https://akshare.akfamily.xyz/installation.html#anaconda "Link to this heading")
```
pip install akshare --upgrade --user -i https://pypi.tuna.tsinghua.edu.cn/simple

```

## 升级 [AKShare](https://github.com/akfamily/akshare)[](https://akshare.akfamily.xyz/installation.html#id4 "Link to this heading")
...
## M 系列芯片支持[](https://akshare.akfamily.xyz/installation.html#m "Link to this heading")
...
## 树莓派支持[](https://akshare.akfamily.xyz/installation.html#id5 "Link to this heading")
...
## R 语言调用支持[](https://akshare.akfamily.xyz/installation.html#r "Link to this heading")
...
### 安装 Anaconda[](https://akshare.akfamily.xyz/installation.html#id6 "Link to this heading")
[下载 Windows 64 位 Python 3.8 的 Anaconda](https://repo.anaconda.com/archive/Anaconda3-2020.07-Windows-x86_64.exe)
[安装教程参见 AKShare 文档的环境配置专栏](anaconda.html.md)
### 安装 R 语言[](https://akshare.akfamily.xyz/installation.html#id7 "Link to this heading")
...
### 升级 R 语言到最新版本[](https://akshare.akfamily.xyz/installation.html#id8 "Link to this heading")
#### Windows[](https://akshare.akfamily.xyz/installation.html#windows "Link to this heading")
```
...
#### Mac[](https://akshare.akfamily.xyz/installation.html#mac "Link to this heading")
从 [CRAN website](https://cran.r-project.org/) 网站下载和安装最新的版本，覆盖升级即可。
### 在 R 语言中安装相应的包[](https://akshare.akfamily.xyz/installation.html#id9 "Link to this heading")
...
## MATLAB 调用支持[](https://akshare.akfamily.xyz/installation.html#matlab "Link to this heading")
**推荐使用[AKTools 项目](https://github.com/akfamily/aktools) 来部署 AKShare 的 HTTP API 使用，运行速度更快，更稳定，兼容各种编程语言，详情参考 [AKTools 文档](https://aktools.readthedocs.io/)**
### 安装 Anaconda[](https://akshare.akfamily.xyz/installation.html#id10 "Link to this heading")
[下载 Windows 平台带 64 位 Python 的 Anaconda](https://repo.anaconda.com/archive/)，其需要符合 [Matlab 各版本对 Python 的支持](https://www.mathworks.com/support/requirements/python-compatibility.html?s_tid=srchtitle_site_search_1_python%20compatibility) ，比如 `Matlab R2023b` 目前支持 `Python` 的 `3.9, 3.10, 3.11` 版本。
[Anaconda 安装教程参见 AKShare 文档的环境配置专栏](anaconda.html.md)
### 安装 MATLAB[](https://akshare.akfamily.xyz/installation.html#id11 "Link to this heading")
通过 [下载 64 位 MATLAB R2023b](https://ww2.mathworks.cn/downloads/message/error_page/unlicensed?release=R2023b) 页面 来登录后下载激活。
通过官方安装文档 [安装 64 位 MATLAB](https://ww2.mathworks.cn/help/install/ug/install-products-on-client-machines.html) 来 进行安装配置。
### 配置环境[](https://akshare.akfamily.xyz/installation.html#id12 "Link to this heading")
...
如果使用虚拟环境，则 `pyenv(Version="C:\Users\albert\.conda\envs\matlab\python.exe");` 即可激活相关环境， 此处 `C:\Users\albert\.conda\envs\matlab\python.exe` 为本地虚拟环境的路径。
#### 测试环境配置[](https://akshare.akfamily.xyz/installation.html#id13 "Link to this heading")
在 MATLAB 命令行窗口输入：
```
pyenv
...
则表示可以正常使用 `C:\Users\albert\.conda\envs\matlab\python` 虚拟环境中的 Python， 同时确保在该环境中已经安装最新版的 AKShare（可以在本地 conda 中名为 `matlab` 的虚拟环境中查看）。
#### 测试调用 AKShare 接口[](https://akshare.akfamily.xyz/installation.html#id14 "Link to this heading")
在 MATLAB 命令行窗口输入：
```
...
### 调用 AKShare[](https://akshare.akfamily.xyz/installation.html#id15 "Link to this heading")
#### 不带参数接口调用[](https://akshare.akfamily.xyz/installation.html#id16 "Link to this heading")
在 MATLAB 命令行窗口输入：
```
...
#### 带参数接口调用[](https://akshare.akfamily.xyz/installation.html#id17 "Link to this heading")
在 MATLAB 命令行窗口输入：
```
...
### 转换数据格式[](https://akshare.akfamily.xyz/installation.html#id18 "Link to this heading")
#### 演示[](https://akshare.akfamily.xyz/installation.html#id19 "Link to this heading")
```
% 导入 AKShare 库
...
## 安装报错解决方案[](https://akshare.akfamily.xyz/installation.html#id20 "Link to this heading")
### 1. 安装超时的错误[](https://akshare.akfamily.xyz/installation.html#id21 "Link to this heading")
1.大致报错如下, 出现关键词 **amt** :
```
...
方法二
使用全局代理解决
### 2. 拒绝访问错误[](https://akshare.akfamily.xyz/installation.html#id22 "Link to this heading")
1.大致报错如下, 出现关键词 **拒绝访问** :
```
...
### 3. 提示其他的错误[](https://akshare.akfamily.xyz/installation.html#id23 "Link to this heading")
  * 方法一: 确认并升级您已安装 64 位的 **Python 3.9** 及以上版本
  * 方法二: 使用 conda 的虚拟环境来安装, 详见 **[AKShare](https://github.com/akfamily/akshare) 环境配置** 板块的内容

[ 上一页](introduction.html _AKShare 项目概览_.md) [下一页 ](data_index.html _AKShare 数据字典_.md)

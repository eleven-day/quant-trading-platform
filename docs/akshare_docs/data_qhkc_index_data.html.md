...
[AKShare](index.html.md)
  ...
  * [AKShare 奇货可查](data_qhkc_index.html.md)
  * 指数
  * [ 查看页面源码](_sources_data_qhkc_index_data.md.txt.md)

# 指数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id1 "Link to this heading")
## 指数信息[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id2 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id3 "Link to this heading")
index_info
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id4 "Link to this heading")
指数信息接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id5 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
index_id | 指数id | index0070c0eb-93ba-2da9-6633-fa70cb90e959  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id6 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
name | string | 指数名称  
...
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id7 "Link to this heading")
```
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id8 "Link to this heading")
```
...
## 指数权重数据[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id9 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id10 "Link to this heading")
index_weights
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id11 "Link to this heading")
指数权重数据接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id12 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
index_id | 指数id | index0070c0eb-93ba-2da9-6633-fa70cb90e959  
date | 查询日期 | 2018-08-08  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id13 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
variety | string | 品种编码  
weight | float | 权重值，百分数  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id14 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id15 "Link to this heading")
```
 variety   weight
0   RB 37.714204
1    I 18.168484
...
## 指数行情数据[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id16 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id17 "Link to this heading")
index_quotes
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id18 "Link to this heading")
指数行情数据接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id19 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
index_id | 指数id | index0070c0eb-93ba-2da9-6633-fa70cb90e959  
date | 查询日期 | 2018-08-08  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id20 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
trans_date | date | 日期  
volume | int | 指数成交量  
...
price | float | 指数价格  
bbr | float | 指数多空比  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id21 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id22 "Link to this heading")
```
      index_quotes
...
## 指数沉淀资金数据[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id23 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id24 "Link to this heading")
index_money
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id25 "Link to this heading")
指数沉淀资金数据接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id26 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
index_id | 指数id | index0070c0eb-93ba-2da9-6633-fa70cb90e959  
date | 查询日期 | 2018-08-08  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id27 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
trans_date | date | 查询日期  
total_value | float | 指数沉淀资金，单位元  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id28 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id29 "Link to this heading")
```
       index_money
trans_date  2018-08-08
...
## 公共指数列表[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id30 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id31 "Link to this heading")
index_official
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id32 "Link to this heading")
公共指数列表接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id33 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
- | - | -  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id34 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
id | string | 指数id  
name | string | 指数名  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id35 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id36 "Link to this heading")
```
                      id  name
...
## 个人指数列表[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id37 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id38 "Link to this heading")
index_mine
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id39 "Link to this heading")
个人指数列表接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id40 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
- | - | -  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id41 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
id | string | 指数id  
name | string | 指数名  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id42 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id43 "Link to this heading")
```
                      id  name
...
## 指数资金动向[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id44 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id45 "Link to this heading")
index_trend
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id46 "Link to this heading")
指数资金动向接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id47 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
index_id | 指数id | index0070c0eb-93ba-2da9-6633-fa70cb90e959  
date | 查询日期 | 2018-08-08  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id48 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
broker | string | 席位  
variety | string | 品种编码  
money | float | 净持仓资金变化，正数为流多，负数为流空，单位元  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id49 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id50 "Link to this heading")
```
...
## 指数的席位盈亏数据[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id51 "Link to this heading")
### 接口名称[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id52 "Link to this heading")
index_profit
### 接口描述[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id53 "Link to this heading")
指数的席位盈亏数据接口
### 请求参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id54 "Link to this heading")
参数名 | 说明 | 举例  
---|---|---  
index_id | 指数id | index0070c0eb-93ba-2da9-6633-fa70cb90e959  
start_date | 查询开始日期 | 2018-07-08  
end_date | 查询结束日期 | 2018-08-08  
### 返回参数[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id55 "Link to this heading")
参数名 | 类型 | 说明  
---|---|---  
broker | string | 席位  
profit | float | 盈亏金额，正数为盈利，负数为亏损，单位元  
### 示例代码[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id56 "Link to this heading")
```
fromakshareimport pro_api
pro = pro_api(token="在此处输入您的 token, 可以联系奇货可查网站管理员获取")
...
### 返回示例[](https://akshare.akfamily.xyz/data/qhkc/index_data.html#id57 "Link to this heading")
```
  broker   profit
0   中辉期货 -236037050
1   国富期货 -211233900
...
[ 上一页](data_qhkc_broker.html _席位_.md) [下一页 ](data_qhkc_fundamental.html _基本面_.md)

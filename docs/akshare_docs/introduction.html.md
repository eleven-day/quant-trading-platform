...
[AKShare](index.html.md)
  * [](index.html.md)
  * AKShare 项目概览
  * [ 查看页面源码](_sources_introduction.md.txt.md)

# [AKShare](https://github.com/akfamily/akshare) 项目概览[](https://akshare.akfamily.xyz/introduction.html#akshare "Link to this heading")
...
**风险提示** ：[AKShare](https://github.com/akfamily/akshare) 开源财经数据接口库所采集的数据皆来自公开的数据源，不涉及任何个人隐私数据和非公开数据。 同时本项目提供的数据接口及相关数据仅用于学术研究，任何个人、机构及团体使用本项目的数据接口及相关数据请注意商业风险。
  1. 本文档更新时间：**2025-06-03** ；
...
## 引用[](https://akshare.akfamily.xyz/introduction.html#id1 "Link to this heading")
...
## [AKShare](https://github.com/akfamily/akshare) 的介绍[](https://akshare.akfamily.xyz/introduction.html#id2 "Link to this heading")
...
## [AKShare](https://github.com/akfamily/akshare) 的特色[](https://akshare.akfamily.xyz/introduction.html#id3 "Link to this heading")
...
## [AKShare](https://github.com/akfamily/akshare) 的初衷[](https://akshare.akfamily.xyz/introduction.html#id4 "Link to this heading")
[AKShare](https://github.com/akfamily/akshare) 主要是用于财经研究，解决在财经研究中数据获取的问题。目前的版本主要是基于 Python 语言，通过调用相关的数据接口来获取数据到本地。原理上，就是在用户本地运行 Python 代码，实时从网络采集数据到本地，便利与数据分析。由于网络数据采集需要维护的接口众多，且经常由于目标网站变换网页格式需要维护及更新相关接口，所以用户在使用本项目的过程中需要经常更新本项目到最新版本。同时也需要关注项目文档的更新，因为最新的使用方式和接口变更都会第一时间更新到文档中。
[ 上一页](index.html _欢迎访问 AKShare 在线文档！_.md) [下一页 ](installation.html _AKShare 安装指导_.md)

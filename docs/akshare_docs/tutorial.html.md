...
Table of contents:
  ...
  * [AKShare 快速入门](tutorial.html.md)
    ...
    * [案例演示](https://akshare.akfamily.xyz/tutorial.html#id2)
      * [期货展期收益率](https://akshare.akfamily.xyz/tutorial.html#id3)
...
[AKShare](index.html.md)
  * [](index.html.md)
  * AKShare 快速入门
  * [ 查看页面源码](_sources_tutorial.md.txt.md)

# [AKShare](https://github.com/akfamily/akshare/) 快速入门[](https://akshare.akfamily.xyz/tutorial.html#akshare "Link to this heading")
## 查看数据[](https://akshare.akfamily.xyz/tutorial.html#id1 "Link to this heading")
具体函数使用详情, 请查看 [AKShare 文档](index.md) 每个接口的示例代码
...
## 案例演示[](https://akshare.akfamily.xyz/tutorial.html#id2 "Link to this heading")
### 期货展期收益率[](https://akshare.akfamily.xyz/tutorial.html#id3 "Link to this heading")
示例代码
```
importakshareasak
...
[ 上一页](answer.html _AKShare 答疑专栏_.md) [下一页 ](articles.html _AKShare 相关文章_.md)
